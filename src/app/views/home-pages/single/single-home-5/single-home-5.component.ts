...
import { SingleHeader5Component } from "./components/single-header-5/single-header-5.component";
...
@Component({
  selector: 'app-single-home-5',
  imports: [SingleHeader5Component, Hero5Component, About5Component, Work5Component, Services5Component, WhyChoose4Component, Team5Component, Contact5Component, Testimonial5Component, Blogs5Component, Footer5Component],
  templateUrl: './single-home-5.component.html',
  styles: ``
})
export class SingleHome5Component {
