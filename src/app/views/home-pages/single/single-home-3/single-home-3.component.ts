...
@Component({
  selector: 'app-single-home-3',
  imports: [Hero3Component, About3Component, Services3Component, Work3Component, CaseStudies3Component, Team3Component, Testimonial3Component, Blogs3Component, Cta3Component, Footer3Component, SingleHeader3Component],
  templateUrl: './single-home-3.component.html',
  styles: ``
})
export class SingleHome3Component {
